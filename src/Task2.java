...
public class Task2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Comptage des paires (A → B) en ligne:
        ...
        // Construction du graphe orienté filtré (seuil ≥ 6):
        ...
        // Détection des composantes fortement connexes (Kosaraju):
        ...
        //Pour debug CFCs
        System.out.println("Taille order: " + order.size());
        System.out.println("Taille allAuthors: " + allAuthors.size());
        ...
        // AFFICHAGE TOP 10 en fonction des DIAMÈTRES:
        ...
        // HISTOGRAMME des tailees des CFCs:
        ...
        try (PrintWriter writer = new PrintWriter("../output/histogramme_cfc.txt")) {
            writer.println("# Taille_CFC Nombre_CFC");
            for (var entry : sizeHistogram.entrySet()) {
                writer.println(entry.getKey() + " " + entry.getValue());
            }
        }
        System.out.println("Histogramme sauvegardé dans: ../output/histogramme_cfc.txt");


        // SAUVEGARDE des résultats complets//

        saveResultsWithDiameter(components, graph, "../output/resultats_tache2_complet.txt");
        ...
        // Génération du graphique et mettre comme PNG (JFreeChart)
        try {
