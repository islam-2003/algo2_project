...
public class Task1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("\n ========== FIN DU PARSING ==========");
        System.out.println("Publications traitées: " + pubCount);
        System.out.println("Nombre de communautés: " + uf.getCommunityCount());
        Map<Integer, Integer> histogram = new TreeMap<>();
            for (String author : uf.getParent().keySet()) {
                if (uf.find(author).equals(author)) {
                    int s = uf.getSizes().get(author);
